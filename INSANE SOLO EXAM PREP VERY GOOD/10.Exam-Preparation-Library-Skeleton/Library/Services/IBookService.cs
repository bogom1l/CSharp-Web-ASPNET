...
namespace Library.Services
{
    public interface IBookService
    {
        ...
        Task<AddBookViewModel?> GetBookByIdForEditAsync(int bookId);

        Task EditBookAsync(int bookId, AddBookViewModel bookViewModel);

        Task DeleteBookAsync(BookViewModel bookViewModel);
    }
}
