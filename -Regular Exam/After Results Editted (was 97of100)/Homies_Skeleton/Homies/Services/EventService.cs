...
namespace Homies.Services
{
    public class EventService : IEventService
    {
        ...
        public async Task<AddEventViewModel?> GetAddEventViewModelByIdAsync(int id, string userId)
        {
            //add validation if the user is the organiser of the event -> return null
            if (!this._dbContext.Events.Any(e => e.Id == id && e.OrganiserId == userId))
            {
                return null;
            }
